...
class StockPage(db.Model):
    ...
    Change_perc = Column(Float, default=0)
    zip = Column(String(6))
    ...
    companyOfficers = Column(Float, default=0)
    website = Column(String(50))
    maxAge = Column(Integer)
    address1 = Column(String(200))
    industry = Column(String(50))
    ebitdaMargins = Column(Float, default=0)
    profitMargins = Column(Float, default=0)
    grossMargins = Column(Float, default=0)
    operatingCashflow = Column(Integer)
    revenueGrowth = Column(Float, default=0)
    operatingMargins = Column(Float, default=0)
    ...
    currentPrice = Column(Float, default=0)
    earningsGrowth = Column(Integer)
    currentRatio = Column(Float, default=0)
    returnOnAssets = Column(Float, default=0)
    numberOfAnalystOpinions = Column(Integer)
    targetMeanPrice = Column(Float, default=0)
    debtToEquity = Column(Float, default=0)
    returnOnEquity = Column(Float, default=0)
    targetHighPrice = Column(Float, default=0)
    totalCash = Column(Float, default=0)
    totalDebt = Column(Float, default=0)
    totalRevenue = Column(Float, default=0)
    totalCashPerShare = Column(Float, default=0)
    financialCurrency = Column(String(10))
    revenuePerShare = Column(Float, default=0)
    quickRatio = Column(Float, default=0)
    recommendationMean = Column(Float, default=0)
    exchange = Column(String(10))
    shortName = Column(String(100))
    longName = Column(String(200))
    regularMarketPrice = Column(Float, default=0)
