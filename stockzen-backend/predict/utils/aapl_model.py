...
Original file is located at
    https://colab.research.google.com/drive/1o_f-ugY639LL1nfC14x3GWcVb1u8_lZM
"""
...
torch.save(model, f = 'models/AAPL.pt')

# predict the closing price of the next trading day

new_model = torch.load('models/AAPL.pt')
new_model.eval()
...
# print("\nTraining accuracy is %f%%" % (accuracy*100))
print(accuracy)

AAPL_results = {'AAPL': accuracy}
# print(MSFT_results)
with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(AAPL_results, f, ensure_ascii=False, indent=4)