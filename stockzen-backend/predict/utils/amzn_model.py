...
Original file is located at
    https://colab.research.google.com/drive/18JC3GQcC-4jdhS-4xcFpQEkaB8H35tzT
"""
...
torch.save(model, f = 'models/AMZN.pt')

# predict the closing price of the next trading day

new_model = torch.load('models/AMZN.pt')
new_model.eval()
...
AMZN_results = {'AMZN': accuracy}
# print(MSFT_results)
with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(AMZN_results, f, ensure_ascii=False, indent=4)