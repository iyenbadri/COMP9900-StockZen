...
Original file is located at
    https://colab.research.google.com/drive/10EC7m_KFW5ZE5Q6D8q3IV3SaN89sby_Z
"""
...
torch.save(model, f = 'models/BAC.pt')



# predict the closing price of the next trading day

new_model = torch.load('models/BAC.pt')
new_model.eval()
...
BAC_results = {'BAC': accuracy}

with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(BAC_results, f, ensure_ascii=False, indent=4)