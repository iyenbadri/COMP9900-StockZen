...
Original file is located at
    https://colab.research.google.com/drive/1bhEf-jkk0vq-BSyG9gd-4aARr6kcVFvc
"""
...
torch.save(model, f = 'models/BRK-B.pt')

# predict the closing price of the next trading day

new_model = torch.load('models/BRK-B.pt')
new_model.eval()
...
BRK-B_results = {'BRK-B': accuracy}

with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(BRK-B_results, f, ensure_ascii=False, indent=4)