...
Original file is located at
    https://colab.research.google.com/drive/1IKLvn5xYEyFdfcURHZnJLjrnsjK77LiY
"""
...
def stockTimeSeries(sym):
    stock = yf.Ticker(sym)
    price = stock.history(start = '2009-02-13')
    price["Stock"] = sym
    return price 
...
torch.save(model, f = 'models/DIS.pt')

# predict the closing price of the next trading day

new_model = torch.load('models/DIS.pt')
new_model.eval()
...
DIS_results = {'DIS': accuracy}

with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(DIS_results, f, ensure_ascii=False, indent=4)