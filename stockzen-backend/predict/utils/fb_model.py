...
Original file is located at
    https://colab.research.google.com/drive/1-HuTQUnslsu1kV8dYOG2x6qPjL_gM8VM
"""
...
torch.save(model, f = 'models/FB.pt')

# predict the closing price of the next trading day

new_model = torch.load('models/FB.pt')
new_model.eval()
...
FB_results = {'FB': accuracy}

with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(FB_results, f, ensure_ascii=False, indent=4)