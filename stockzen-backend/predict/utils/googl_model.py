...
Original file is located at
    https://colab.research.google.com/drive/1NuCufk_HV_GTHpQciTCT6JfKjN2IqDhL
"""
...
torch.save(model, f = 'models/GOOGL.pt')

# predict the closing price of the next trading day

new_model = torch.load('models/GOOGL.pt')
new_model.eval()
...
GOOGL_results = {'GOOGL': accuracy}

with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(GOOGL_results, f, ensure_ascii=False, indent=4)