...
Original file is located at
    https://colab.research.google.com/drive/1kIf2mGsLJfgY72yJm1r4JavEJQy0aUwU
"""
...
torch.save(model, f = 'models/HD.pt')



# predict the closing price of the next trading day

new_model = torch.load('models/HD.pt')
new_model.eval()
...
HD_results = {'HD': accuracy}

with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(HD_results, f, ensure_ascii=False, indent=4)