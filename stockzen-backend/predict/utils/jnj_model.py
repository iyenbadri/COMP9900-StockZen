...
Original file is located at
    https://colab.research.google.com/drive/1JhL4D1qN74E9-14WXGWldpY45qUMl55Q
"""
...
def stockTimeSeries(sym):
    stock = yf.Ticker(sym)
    price = stock.history(start = '1997-01-01')
    price["Stock"] = sym
    return price 
...
torch.save(model, f = 'models/JNJ.pt')



# predict the closing price of the next trading day

new_model = torch.load('models/JNJ.pt')
new_model.eval()
...
JNJ_results = {'JNJ': accuracy}

with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(JNJ_results, f, ensure_ascii=False, indent=4)