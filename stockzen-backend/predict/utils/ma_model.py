...
Original file is located at
    https://colab.research.google.com/drive/1pwACuqeW2yzoZwevVkLsGqsIGTTJiA3q
"""
...
torch.save(model, f = 'models/MA.pt')

# predict the closing price of the next trading day

new_model = torch.load('models/MA.pt')
new_model.eval()
...
MA_results = {'MA': accuracy}

with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(MA_results, f, ensure_ascii=False, indent=4)