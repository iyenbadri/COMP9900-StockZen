...
Original file is located at
    https://colab.research.google.com/drive/1cc3tWf4nuaI8R-fs3sBQ6zKh2OI1v3Ve
"""
...
torch.save(model, f = 'models/MSFT.pt')

# predict the closing price of the next trading day

new_model = torch.load('models/MSFT.pt')
new_model.eval()
...
MSFT_results = {'MSFT': accuracy}
# print(MSFT_results)
with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(MSFT_results, f, ensure_ascii=False, indent=4)