...
Original file is located at
    https://colab.research.google.com/drive/1JNF7yyQ7tbFVgrTJ3pxpWYpvlEmyAd90
"""
...
def stockTimeSeries(sym):
    stock = yf.Ticker(sym)
    price = stock.history(start = '2013-02-01')
    price["Stock"] = sym
    return price 
...
torch.save(model, f = 'models/NFLX.pt')

# predict the closing price of the next trading day

new_model = torch.load('models/NFLX.pt')
new_model.eval()
...
NFLX_results = {'NFLX': accuracy}

with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(NFLX_results, f, ensure_ascii=False, indent=4)