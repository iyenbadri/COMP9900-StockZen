...
Original file is located at
    https://colab.research.google.com/drive/1_mB7RHH54uaygRNR8w0uRXEJmhmuaCMi
"""
...
torch.save(model, f = 'models/NVDA.pt')

# predict the closing price of the next trading day

new_model = torch.load('models/NVDA.pt')
new_model.eval()
...
NVDA_results = {'NVDA': accuracy}

with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(NVDA_results, f, ensure_ascii=False, indent=4)