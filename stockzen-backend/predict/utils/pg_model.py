...
Original file is located at
    https://colab.research.google.com/drive/1HVtZruzNqHvSMSTy8k9EFUfM-ghq-sbf
"""
...
torch.save(model, f = 'models/PG.pt')

# predict the closing price of the next trading day

new_model = torch.load('models/PG.pt')
new_model.eval()
...
PG_results = {'PG': accuracy}

with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(PG_results, f, ensure_ascii=False, indent=4)