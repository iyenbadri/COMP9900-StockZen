...
Original file is located at
    https://colab.research.google.com/drive/1_ryx7GqLk45Uh44vMblrzHQUFQVyLjui
"""
...
def stockTimeSeries(sym):
    stock = yf.Ticker(sym)
    price = stock.history(start = '2015-07-01')
    price["Stock"] = sym
    return price 
...
torch.save(model, f = 'models/PYPL.pt')

# predict the closing price of the next trading day

new_model = torch.load('models/PYPL.pt')
new_model.eval()
...
PYPL_results = {'PYPL': accuracy}

with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(PYPL_results, f, ensure_ascii=False, indent=4)