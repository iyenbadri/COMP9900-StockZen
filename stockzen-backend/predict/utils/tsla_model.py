...
Original file is located at
    https://colab.research.google.com/drive/1CalYB1lVdAplmM0L4g78uK99UTZdPmOB
"""
...
def stockTimeSeries(sym):
    stock = yf.Ticker(sym)
    price = stock.history(start = '2018-09-16')
    price["Stock"] = sym
    return price 
...
torch.save(model, f = 'models/TSLA.pt')

# predict the closing price of the next trading day

new_model = torch.load('models/TSLA.pt')
new_model.eval()
...
TSLA_results = {'TSLA': accuracy}
# print(MSFT_results)
with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(TSLA_results, f, ensure_ascii=False, indent=4)