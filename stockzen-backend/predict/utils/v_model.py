...
Original file is located at
    https://colab.research.google.com/drive/1I6D0HtQDiEvHXkiWr2n9RMXxRsE6UIYs
"""
...
torch.save(model, f = 'models/V.pt')



# predict the closing price of the next trading day

new_model = torch.load('models/V.pt')
new_model.eval()
...
V_results = {'V': accuracy}

with open('results.json', 'a+', encoding='utf-8') as f:
    json.dump(V_results, f, ensure_ascii=False, indent=4)